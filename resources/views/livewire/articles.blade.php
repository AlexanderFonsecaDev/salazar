        ...
        <div class="pt-24">
            <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
                ...
                <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
                    <p class="uppercase tracking-loose w-full">Formamos jóvenes capaces de tomar sus propias decisiones con responsabilidad y asertividad.</p>
                    <h1 class="my-4 text-5xl font-bold leading-tight">
                        Ofreciendo educación de calidad
                    </h1>
                    <p class="leading-normal text-2xl mb-8">
                        Se fomenta el espíritu de compañerismo y de ayuda mutua.
                    </p>

                    <a class="mx-auto lg:mx-0 hover:underline bg-white text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out" href="{{ route('articles.create') }}">
                        Ingresar
                    </a>
                </div>
                <!--Right Col-->
                <div class="w-full md:w-3/5 py-6 text-center">
                    <img class="w-full md:w-4/5 z-50" src="{{ asset('images/header/header-min.jpg') }}"/>
                </div>
            </div>
        </div>
    @endsection
                ...
                <div class="flex flex-wrap">
                    <div class="w-5/6 sm:w-1/2 p-6">
                        ...
                        <p class="text-gray-600 mb-8">
                            Nuestro compromiso con los alumnos y sus familias es ofrecer una formación integral,
                            más allá del plan académico, ayudándolos a reconocer en sí mismos sus fortalezas y
                            enseñándoles a gestionar los retos del futuro
                        </p>
                    </div>
